...
function PollOptions({ setActiveStep, newVote, setNewVote }: any) {
  return (
    <>
      <Heading mb={8} size="md">Set up the options of your poll</Heading>
      ...
      <FormControl mt={4}>
        {newVote.options.map((option: any, index: any) => (
